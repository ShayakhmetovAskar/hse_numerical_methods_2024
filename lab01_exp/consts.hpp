...
template <typename F> constexpr inline F c_Sqrt2;
template <> constexpr inline float c_Sqrt2<float> = (float)M_SQRT2;
template <> constexpr inline double c_Sqrt2<double> = M_SQRT2;
template <>
