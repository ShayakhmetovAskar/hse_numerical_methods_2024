...
int main() {
  ...
  long double result;
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::x,
                                 ADAAI::DiffMethod::stencil3>(&func, x, y);
  std::cout << "df/dx using stencil3: " << result << '\n';
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::x,
                                 ADAAI::DiffMethod::stencil3Extra>(&func, x, y);
  std::cout << "df/dx using stencil3Extra: " << result << '\n';
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::x,
                                 ADAAI::DiffMethod::stencil5>(&func, x, y);
  std::cout << "df/dx using stencil5: " << result << '\n';
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::x,
                                 ADAAI::DiffMethod::stencil5Extra>(&func, x, y);
  std::cout << "df/dx using stencil5Extra: " << result << '\n';
  std::cout << "df/dx using FwdAAD: " << v.get_d1()[0] << '\n';
  std::cout << '\n';

  result = ADAAI::Differentiator<ADAAI::WhichDerivative::y,
                                 ADAAI::DiffMethod::stencil3>(&func, x, y);
  ...
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::xx,
                                 ADAAI::DiffMethod::stencil3>(&func, x, y);
  ...
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::yy,
                                 ADAAI::DiffMethod::stencil3>(&func, x, y);
  ...
  result = ADAAI::Differentiator<ADAAI::WhichDerivative::xy,
                                 ADAAI::DiffMethod::stencil3>(&func, x, y);
